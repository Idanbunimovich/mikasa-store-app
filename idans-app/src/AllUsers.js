            ...
            <div className="pa4">
                <table className="f9 w-100 mw8 center" cellSpacing="0">
                    ...
                    {this.props.allusers.map((user,i)=>{
                        return <User id={allusers[i].id} name={allusers[i].name} email={allusers[i].email} basketball={allusers[i].basketball} volleyball={allusers[i].volleyball} footy={allusers[i].footy} soccer={allusers[i].soccer} futsal={allusers[i].futsal}/>
                    })
                    }
                </table>
            </div>
